...
In this exercise, you'll learn to set up proactive monitoring and alerting for your Azure infrastructure. You'll configure Azure Monitor alerts and use Azure SRE Agent to investigate incidents and create Root Cause Analysis (RCA) reports (TODO!).
